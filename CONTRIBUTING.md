...
If you find a bug in the source code, you can help us by [submitting an issue](https://github.com/kaleidos-ventures/taiga-contrib-protected/issues/new/choose). Even better, you can submit a Pull Request with a fix.
